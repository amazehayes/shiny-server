...
total <- setNames(total, c("Year","Player","Position","Age","Season","Round","Overall",
                           ...
                           "RecTDs","Targets/G","Receptions/G","YPTarget","YPR",
                           ...
                           "MS.RushAtt","MS.RushYards","MS.RushTDs","MS.Targets","MS.Receptions","MS.RecYards","MS.RecTDs",
                           "MS.Touches","MS.TotalYards","MS.TotalTDs",
...
rbdata <- setNames(rbdata,c("Year","Player","Age","Season","Round","Overall",
                            ...
                            "RZ.RecTD%<10","RZ.%RecTD<10","RZ.TeamTarget%<10","RZ.Touches<20","RZ.TotalYards<20",
                            "RZ.TotalTDs<20","RZ.%Touches<20","RZ.TotalTD%<20","RZ.%TotalTD<20",
                            "RZ.Touches<10","RZ.TotalYards<10","RZ.TotalTDs<10","RZ.%Touches<10",
...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    menuItem("Consistency", tabName = "consistency", icon = icon("table"),
             menuSubItem("Consistency Datatable", tabName = "condata"),
    ...
    menuItem("Defenses - Points Allowed", tabName = "defense", icon = icon("table"),
             menuSubItem("Data by Team", tabName = "teamdefense"),
             menuSubItem("Averages", tabName = "avgdefense")),
    menuItem("Database", tabName = "database", icon = icon("database"),
             menuSubItem("Database Query", tabName = "query"),
    ...
    menuItem("Z-Score Analysis", tabName = "zscore", icon = icon("bar-chart"),
             menuSubItem("Z-Score Datatable",tabName = "zdata"),
             menuSubItem("Z-Score Graphs",tabName = "zgraph")),
  ...
  dashboardBody(
    ...
    tabItem(tabName = "query",
            fluidRow(
              ...
              column(4, selectInput("query_col","Select Column(s):", choices = list(
                ...
                MarketShare = c("MS.RushAtt","MS.RushYards","MS.RushTDs","MS.Targets","MS.Receptions","MS.RecYards","MS.RecTDs",
                                "MS.Touches","MS.TotalYards","MS.TotalTDs"),
                RedZone20 = c("RZ.PassAtt<20","RZ.PassComp<20","RZ.Comp%<20","RZ.TDs<20","RZ.INTs<20",
    ...
    tabItem(tabName = "customoff",
            ...
            fluidRow(
             column(2, numericInput("off_numberA", "PP Pass Attempt:",
                                     value = 0, min = 0, max = 1, step = 0.01)),
             column(2, numericInput("off_numberB", "PP Pass Compl:",
                                    value = 0, min = 0, max = 1, step = 0.01)),
             column(2, numericInput("off_numberL", "PP Pass Incompl:",
                                    value = 0, min = -2, max = 0, step = 0.01)),
             column(2, numericInput("off_numberC", "PP Pass Yard:",
                                    value = 0.04, min = 0, max = 1, step = 0.01)),
             column(2, numericInput("off_numberD", "PP Pass TD:",
                                    value = 4, min = 0, max = 10, step = 1)),
             column(2, numericInput("off_numberE", "PP INT:",
                                    value = -2, min = -5, max = 5, step = 1))),
            fluidRow(
             column(2, numericInput("off_numberF", "PP Carry:",
                                     value = 0, min = 0, max = 1, step = 0.01)),
             column(2, numericInput("off_numberG", "PP Reception:",
                                    value = 1, min = 0, max = 5, step = 0.1)),
             column(2, numericInput("off_numberJ", "TE PPR Premium:",
                                    value = 1, min = 0, max = 5, step = 0.1)),
             column(2, numericInput("off_numberH", "PP Rush/Rec Yard:",
                                    value = 0.1, min = 0, max = 5, step = 0.1)),
             column(2, numericInput("off_numberI", "PP Rush/Rec TD:",
                                    value = 6, min = 0, max = 10, step = 1)),
             column(2, numericInput("off_numberK", "PP Return Yard:",
                                    value = 0, min = 0, max = 1, step = 0.01))),
    ...
    tabItem(tabName = "customdef",
            ...
            fluidRow(
              column(2, numericInput("def_numberA", "PP Tackle:",
                                     value = 1, min = 0, max = 10, step = 0.1)),
              column(2, numericInput("def_numberB", "PP Assist:",
                                     value = 0.5, min = 0, max = 10, step = 0.1)),
              column(2, numericInput("def_numberC", "PP Sack:",
                                     value = 4, min = 0, max = 20, step = 0.1)),
              column(2, numericInput("def_numberD", "PP Pass Defensed:",
                                     value = 1, min = 0, max = 10, step = 0.1)),
              column(2, numericInput("def_numberE", "PP Interception:",
                                     value = 5, min = 0, max = 20, step = 0.1))),
            fluidRow(
              column(2, numericInput("def_numberF", "PP Forced Fumble:",
                                     value = 3, min = 0, max = 20, step = 0.1)),
              column(2, numericInput("def_numberG", "PP Fumble Rec:",
                                     value = 2, min = 0, max = 20, step = 0.1)),
              column(2, numericInput("def_numberH", "PP Safety:",
                                     value = 2, min = 0, max = 10, step = 0.1)),
              column(2, numericInput("def_numberI", "PP TD:",
                                     value = 6, min = 0, max = 20, step = 0.1)),
              column(2, numericInput("def_numberJ", "PP Return Yard:",
                                     value = 0, min = 0, max = 1, step = 0.01))),
